...
pub mod contracts {
    pub mod abicov {
        pub mod structs {
            ...
            #[derive(serde::Deserialize, serde::Serialize)]
            pub struct GenericOne<A> {
                pub a: A,
                pub b: starknet::core::types::Felt,
                pub c: cainome_cairo_serde::U256,
            }
            impl<A> cainome_cairo_serde::CairoSerde for GenericOne<A>
            where
            ...
            impl<A, B> cainome_cairo_serde::CairoSerde for GenericTwo<A, B>
            where
                A: cainome_cairo_serde::CairoSerde<RustType = A>,
                B: cainome_cairo_serde::CairoSerde<RustType = B>,
            {
                type RustType = Self;
                const SERIALIZED_SIZE: std::option::Option<usize> = None;
                #[inline]
...
impl<A: starknet::accounts::ConnectedAccount + Sync> Substitutions<A> {
    ...
    pub fn get_generic_one(
        &self,
    ) -> cainome_cairo_serde::call::FCall<A::Provider, crate::test_substitutions::GenericOneFelt>
    {
        use cainome_cairo_serde::CairoSerde;
    ...
    pub fn get_generic_one_array(
        &self,
    ) -> cainome_cairo_serde::call::FCall<A::Provider, crate::test_substitutions::GenericOneSpanFelt>
    {
        use cainome_cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        let __call = starknet::core::types::FunctionCall {
    ...
    pub fn get_tuple_of_array_generic(
        ...
        A::Provider,
        (
            Vec<crate::test_substitutions::GenericOneu64>,
            Vec<starknet::core::types::Felt>,
        ),
    > {
        use cainome_cairo_serde::CairoSerde;
    ...
    pub fn set_generic_one_getcall(
        &self,
        generic: &crate::test_substitutions::GenericOneu256,
    ) -> starknet::core::types::Call {
        use cainome_cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(crate::test_substitutions::GenericOneu256::cairo_serialize(
            generic,
        ));
        starknet::core::types::Call {
            to: self.address,
    ...
    pub fn set_generic_two_getcall(
        &self,
        generic: &crate::bindings::substitutions::contracts::abicov::structs::GenericTwo<u64, u128>,
    ) -> starknet::core::types::Call {
        use cainome_cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata
    ...
    pub fn set_generic_two_0_getcall(
        &self,
        generic: &crate::bindings::substitutions::contracts::abicov::structs::GenericTwo<u128, u64>,
    ) -> starknet::core::types::Call {
        use cainome_cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata
    ...
    pub fn set_generic_two_2_getcall(
        &self,
        generic: &crate::bindings::substitutions::contracts::abicov::structs::GenericTwo<u64, u64>,
    ) -> starknet::core::types::Call {
        use cainome_cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata
    ...
    pub fn set_tuple_generic_getcall(
        &self,
        value: &(
            crate::test_substitutions::GenericOneu256,
            crate::bindings::substitutions::contracts::abicov::structs::GenericTwo<
                starknet::core::types::Felt,
                u64,
            >,
...
impl<P: starknet::providers::Provider + Sync> SubstitutionsReader<P> {
    ...
    pub fn get_generic_one(
        &self,
    ) -> cainome_cairo_serde::call::FCall<P, crate::test_substitutions::GenericOneFelt> {
        use cainome_cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
    ...
    pub fn get_generic_one_array(
        &self,
    ) -> cainome_cairo_serde::call::FCall<P, crate::test_substitutions::GenericOneSpanFelt> {
        use cainome_cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
