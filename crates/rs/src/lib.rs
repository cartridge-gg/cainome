...
use crate::expand::{Expandable, ExpansionContext, Module, Modules};
...
pub fn abi_to_tokenstream(
    ...
    modules.register_many(contract.expand(&ctx));
    ...
    for structs in &sorted_structs {
        ...
        modules.register_many(s.expand(&ctx));
    }
    ...
    for enumeration in &sorted_enums {
        ...
        modules.register_many(e.expand(&ctx));
    }

    let expanded = modules.to_token_stream();
