...
abigen!(
    ...
    r#"[{"name":"simple_enum::SimpleEnum","type":"enum","variants":[{"name":"Variant1","type":"()"},{"name":"Variant2","type":"()"}]}]"#,
    derives(
        Debug,
        Clone,
        PartialEq,
    ...
    root_module_path("crate::generated_tests")
);
abigen!(
    TestResultErrU32,
...
abigen!(
    ...
    r#"[{"name":"mixed_enum::MixedEnum","type":"enum","variants":[{"name":"Variant1","type":"core::felt252"},{"name":"Variant2","type":"()"}]}]"#,
    derives(
        Debug,
        Clone,
        PartialEq,
...
fn test_simple_enum_variant1() {
    ...
    let test_instance = simple_enum::SimpleEnum::Variant1;
    let serialized = simple_enum::SimpleEnum::cairo_serialize(&test_instance);
    assert_eq!(
        serialized, expected_felt_values,
    ...
    let deserialize_ptr = 0;
    let deserialized =
        simple_enum::SimpleEnum::cairo_deserialize(&serialized, deserialize_ptr).unwrap();
    let reserialized = simple_enum::SimpleEnum::cairo_serialize(&deserialized);
    assert_eq!(
...
fn test_mixed_enum_variant1() {
    ...
    let test_instance = mixed_enum::MixedEnum::Variant1(Felt::from_hex("0x789").unwrap());
    let serialized = mixed_enum::MixedEnum::cairo_serialize(&test_instance);
    assert_eq!(
        serialized, expected_felt_values,
        "Enum serialization mismatch"
    );
    ...
    let deserialize_ptr = 0;
    let deserialized =
        mixed_enum::MixedEnum::cairo_deserialize(&serialized, deserialize_ptr).unwrap();
    let reserialized = mixed_enum::MixedEnum::cairo_serialize(&deserialized);
    assert_eq!(
        serialized, reserialized,
        "Enum roundtrip serialization failed"
    );
...
fn test_struct_with_struct() {
    ...
    let test_instance =
        struct_in_struct::StructWithStruct::cairo_deserialize(&expected_felt_values, 0).unwrap();
    // Test serialization using abigen!-generated type (tests serialization)
    let serialized = struct_in_struct::StructWithStruct::cairo_serialize(&test_instance);
    assert_eq!(
        serialized, expected_felt_values,
        "Struct round-trip serialization failed"
    );
    // Verify we can deserialize again (double round-trip)
    let deserialized_again =
        struct_in_struct::StructWithStruct::cairo_deserialize(&serialized, 0).unwrap();
    let reserialized = struct_in_struct::StructWithStruct::cairo_serialize(&deserialized_again);
